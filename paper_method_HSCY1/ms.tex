...
\begin{document}
\title{FPFS Shear Estimator: Systematic Tests on the First Year Hyper Suprime-Cam Survey}
...
%\author{Surhud More}
%\affiliation{Kavli Institute for the Physics and Mathematics of the Universe (Kavli IPMU, WPI),\\
%UTIAS, Tokyo Institutes for Advanced Study, University of Tokyo, Chiba 277-8583, Japan}
