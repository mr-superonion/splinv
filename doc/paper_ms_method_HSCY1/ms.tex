...
\caption{The results of density maps reconstruction with Point Mass atoms (left) and  NFW atoms (right) with 
        $\lambda=3.5$ (upper) and $\lambda=5.0$ (lower). The input density
