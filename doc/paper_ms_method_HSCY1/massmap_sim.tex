...
randomly shift the input halo redshifts and halo masses from the bin centers
by a small amount. The concentration of the NFW halo is set to as a function of
the halo mass ($M_{200}$) and redshift ($z_{h}$) according to
...
this region is $22.94~\rm{arcmin}^{-2}$. The positions of galaxies are randomized to
...
also shown in Figure \ref{fig_noiseHistogram}. The standard deviation map of the
